...
//    static $T_OPTION = DB_PREFIX . '_option_adddiagramspecial';
    static $T_OPTION = DB_PREFIX . '_option'.ET;
...
//    static $T_PROBLEM = DB_PREFIX . '_problem_adddiagramspecial';
    static $T_PROBLEM = DB_PREFIX . '_problem'.ET;
